                ...
                <form method="post">
                    ...
                    <div class="form-group" style="display: none;">
                        ...
                        <input type="text" name="status" class="form-control"
                               value="<?php echo $user_info->user_role; ?>"/>
                    </div>
                    <div class="form-group">
                        <label>Contact info</label>
                        <input type="text" name="contact_info" class="form-control" autocomplete="off"
                               value="<?php echo $user_info->contact_info ?: "Not filled"; ?>"/>
                    </div>
                    <div class="form-group">
                        <label>Profile description</label>
                        <input type="text" name="profile_description" autocomplete="off" class="form-control"
